...
'    If (Range("ChkChan1") = True) Then PlotData 1, 7000, 1500  ' plot Screen Channel
'    If (Range("ChkChan2") = True) Then PlotData 2, 8500, 1500
